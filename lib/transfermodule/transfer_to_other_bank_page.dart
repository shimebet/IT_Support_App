...
class OtherBankTransferPage extends StatefulWidget {
  final String token;
  const OtherBankTransferPage({super.key, required this.token});
          ...
          leading: const Icon(Icons.transfer_within_a_station),
            children: [
              Column(
                children: [
                  ExpansionTile(
                    title: const Text('Bank of Abyssinia'),
                    onExpansionChanged: (isExpanded) {
                      if (isExpanded) {
                        setState(() {
                          _selectedOtherBankTransferType = 'Bank of Abyssinia';
                          _selectedTransferType = 'Transfer To Other Bank';
                        });
                      } else {
                        setState(() {
                          _selectedOtherBankTransferType = null;
                  ...
                  ExpansionTile(
                    title: const Text('Awash Bank'),
                    onExpansionChanged: (isExpanded) {
                      if (isExpanded) {
                        setState(() {
                          _selectedOtherBankTransferType = 'Awash Bank';
                          _selectedTransferType = 'Transfer To Other Bank';
                        });
                      } else {
                        setState(() {
                    ...
                    children: _selectedOtherBankTransferType == 'Awash Bank'
                        ? [_buildTransferForm()]
                        : [],
                  ),
                ],
